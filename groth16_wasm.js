...
[ "_malloc", "_memory", "___indirect_function_table", "___set_stack_limits", "_main", "onRuntimeInitialized" ].forEach(prop => {
...
var Asyncify = {
  ...
  setDataRewindFunc(ptr) {
    ...
    SAFE_HEAP_STORE((((ptr) + (16)) / 4) * 4, rewindId, 4);
    checkInt32(rewindId);
  },
  getDataRewindFuncName(ptr) {
    var id = SAFE_HEAP_LOAD((((ptr) + (16)) / 4) * 4, 4, 0);
